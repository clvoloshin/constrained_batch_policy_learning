...
class FittedQEvaluation(FittedAlgo):
    def __init__(self, initial_states, num_inputs, dim_state, dim_of_actions, max_epochs, gamma):
        '''
        ...
        super(FittedQEvaluation, self).__init__(num_inputs, dim_state, dim_of_actions, max_epochs, gamma)

    def run(self, dataset, policy, epochs=5000, epsilon=1e-10, desc='FQE'):
